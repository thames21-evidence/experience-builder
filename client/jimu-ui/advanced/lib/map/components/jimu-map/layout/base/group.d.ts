...
export default class Group extends UIComponent<GroupProps, GroupStates> {
    ...
    returnNullNode: (key?: any) => import("@emotion/react/jsx-runtime").JSX.Element;
    checkIsLastElement: (parentGroupJson: GroupJson, toolJson: ToolJson) => boolean;
    getGroupContent: (layoutJson: LayoutJson) => import("@emotion/react/jsx-runtime").JSX.Element;
    checkIsShowGroup: (layoutJson: LayoutJson, children: string[]) => boolean;
    shouldRenderTool(toolName: string, layoutJson: any): boolean;

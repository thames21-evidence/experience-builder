...
export interface AddLineEventConcurrenciesProps {
  intl: IntlShape
...
export function AddLineEventConcurrencies (props: AddLineEventConcurrenciesProps) {
  ...
  const onSubmitClicked = () => {
    if (isDefined(pickedConcurrencyGraphic)) {
      pickedConcurrencyGraphic.removeAll()
    }

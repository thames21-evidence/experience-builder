...
export default class Setting extends React.PureComponent<AllWidgetSettingProps<IMFlexRowConfig>> {
  ...
  render () {
    ...
    return (
      <div className='flex-row-layout-setting'>
        <SettingSection title={this.formatMessage('layout')} role='group' aria-label={this.formatMessage('layout')}>
          <SettingRow label={this.formatMessage('horizontalAlign')}>
            <Select
              aria-label={this.formatMessage('horizontalAlign')}

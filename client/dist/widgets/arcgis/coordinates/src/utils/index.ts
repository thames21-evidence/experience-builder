...
export const projectUnits = ['INCHES', 'FOOT', 'FOOT_US', 'YARDS', 'MILES', 'NAUTICAL_MILES', 'MILLIMETERS',
...
export const geographicUnits = ['DECIMAL_DEGREES', 'DEGREE_MINUTE_SECONDS', 'DEGREE', 'DEGREES_DECIMAL_MINUTES', 'GRAD', 'MGRS', 'USNG']
const unitsValue = {
  // Meter
  INCHES: 0.0254,
  FOOT: 0.3048,

      ...
      if (layer?.useDataSource?.dataSourceId === this.props.editCurrentLayer.layerDsId && layer.analysisInfo.analysisType === AnalysisTypeName.Closest && this.props.analysisIndex === index) {
        ...
        this.setState({
          ...
          if (this.state.sortFeaturesByDistance && (this.props.isActiveMapAreaSelected || this.props.isIncludeOutsideMapAreaSelected)) {
            ...
            const sortFeaturesField: string = objectIdField || ''
            this.setState({
              sortFeaturesByDistance: false,
              sortFeaturesField: [sortFeaturesField]
            }, () => {
      ...
      <SettingSection>
        ...
        <SettingRow className={'mt-4'} flow='wrap'>
          <Label className='m-0 analysisTypeWidth' centric>
            <Radio role={'radio'} aria-label={this.nls(AnalysisTypeName.Closest)}
              className={'cursor-pointer'} data-testid={'closestAnalysis'}
        ...
        {this.state.proximityAnalysisType && this.state.analysisType === AnalysisTypeName.Proximity &&
          <React.Fragment>
            ...
            <SettingRow className={'mt-1 ml-4'} flow={'wrap'}>
              <Label className='m-0' centric>
                <Radio role={'radio'} aria-label={this.nls('distanceLabel')}
                  className={!disableSortByDistance && 'cursor-pointer'}
            ...
            <SettingRow tag='label' label={this.nls('groupFeaturesLabel')}>
              ...
              <Switch role={'switch'} aria-label={this.nls('groupFeaturesLabel')} title={this.nls('groupFeaturesLabel')} data-testid={'groupFeaturesLabel'}
        ...
        <SettingRow tag='label' label={this.nls('displayFeatureCountLabel')}>
          <Tooltip role={'tooltip'} tabIndex={0} aria-label={this.nls('displayFeatureCountInfoTooltip')}
            title={this.nls('displayFeatureCountInfoTooltip')} showArrow placement='top'>
            <div className='title3 text-default mr-4 d-inline'>
              <InfoOutlined />
            </div>
          </Tooltip>
        ...
        {!this.props.isActiveMapAreaSelected &&
          <React.Fragment>
            <SettingRow tag='label' label={this.nls('highlightResultsOnMapLabel')}>
              <Switch role={'switch'} title={this.nls('highlightResultsOnMapLabel')} data-testid={'highlightResultsOnMapLabel'}
        ...
        <SettingRow tag='label' label={this.nls('expandOnOpen')}>
          <Switch role={'switch'} title={this.nls('expandOnOpen')} data-testid={'expandOnOpen'}
        ...
        {!this.props.isActiveMapAreaSelected && this.state.proximityAnalysisType && (this.state.selectedLayerGeometry === 'esriGeometryPolygon' || this.state.selectedLayerGeometry === 'esriGeometryPolyline') &&
          <SettingRow tag='label' label={this.nls('clipFeaturesLabel')}>
            <Tooltip role={'tooltip'} tabIndex={0} aria-label={this.nls('clipFeaturesTooltip')}
              title={this.nls('clipFeaturesTooltip')} showArrow placement='top'>
              <div className='title3 text-default mr-4 d-inline'>
                <InfoOutlined />
              </div>
            </Tooltip>
            <Switch role={'switch'} aria-label={this.nls('clipFeaturesLabel')} title={this.nls('clipFeaturesLabel')}
        ...
        {!this.props.isActiveMapAreaSelected && !this.state.summaryAnalysisType && this.state.selectedLayerGeometry === 'esriGeometryPolygon' &&
          <SettingRow tag='label' label={this.nls('returnIntersectedPolygons')}>
            <Switch role={'switch'} title={this.nls('returnIntersectedPolygons')}
        ...
        {!this.props.isActiveMapAreaSelected && (this.state.closestAnalysisType || this.state.proximityAnalysisType) &&
          <SettingRow className='pt-1' tag='label' label={this.nls('includeApproxDistance')}>
            <Switch role={'switch'} title={this.nls('includeApproxDistance')}

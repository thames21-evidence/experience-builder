/** @jsx jsx */
import { React, ReactRedux, type LayoutTransformFunc, type IMLayoutItemJson } from 'jimu-core';
import type { LayoutProps, StateToLayoutProps, FlowLayoutSetting } from '../../types';
declare class Layout extends React.PureComponent<LayoutProps & StateToLayoutProps> {
    ...
    _createItem(item: IMLayoutItemJson, index: number, layoutSetting: FlowLayoutSetting): import("@emotion/react/jsx-runtime").JSX.Element;
